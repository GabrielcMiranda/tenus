...
public class TaskController {
    ...
    private final TaskLogUsecases taskLogService;
    ...
    @PostMapping("/{id}/tasklog")
    public ResponseEntity<String> createTasklog(@PathVariable Long id, @ModelAttribute TaskLogRequestDTO dto, @AuthenticationPrincipal Jwt jwt) {
        taskLogService.createTaskLog(id, dto, jwt.getSubject());
